...
nb_tests 	= 1200 # This should be sufficient

print("Getting ground truth from model with width {}".format(spde_model.mesh_size[0]))
y_GT, Z = getGroundTruthFromModel(spde_model, wr_model, d, nb_tests, GTfolder = 'TargetL_GTresults', GTfilenames = 'GT_')
