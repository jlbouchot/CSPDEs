...
def Main(outfile = "testCosine3D", d = 5, grid_points = tuple([20, 20, 20]), L_max = 3, algo_name = "whtp", gamma = 1.035, L_min = 3, sampling_name = "p", nb_iter = 50, epsilon = 1e-3, nb_tests = None, alpha = 2.0, abar = 4.3,  dat_constant = 10, experiment_name = "avg_v_3D", tensor_based=True, ansatz_space = 0):
