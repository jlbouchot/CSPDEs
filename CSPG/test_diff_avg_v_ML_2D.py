...
from SPDE.FEniCSModels import DiffusionFEMModelML, CosineCoef2D, ConstantCoefficient, Average
...
def Main(outfile = "testCosineCoefDiff2D", d = 5, grid_points = tuple([200, 200]), L_max = 3, algo_name = "whtp", gamma = 1.035, L_min = 3, sampling_name = "p", nb_iter = 50, epsilon = 1e-3, nb_tests = None, alpha = 2.0, abar = 4.3, imp = 1, dat_constant = 10, experiment_name = "avg_v_2D", tensor_based=True, ansatz_space = 0, t_0 = 1, t_prime = 1, p0 = 1./4., p = 3./10., const_sJ = 5):
    ...
    spde_model = DiffusionFEMModelML(CosineCoef2D(d, alpha, imp, abar), ConstantCoefficient(10.0),
                                       Average(), grid_points) 
