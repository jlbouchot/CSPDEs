...
PWLD_2D("pwld2D_grid2000_var_small_L4", tuple([2000, 2000]), 4, "whtp", 1.06, 5, 1.0/25.0, 1, "p", 50, 1e-3, None)
PWLD_2D("pwld2D_grid2000_var_big_L4", tuple([2000, 2000]), 4, "whtp", 1.06, 5, 2.0, 1, "p", 50, 1e-3, None)